...
type LocalizationEstimate struct {
	...
	RunSignature            *string        `json:"run_signature,omitempty" gorm:"size:64;uniqueIndex:idx_estimate_run_signature"`
	BatchIndex              *int           `json:"batch_index,omitempty"`
	BatchWindowStart        *time.Time     `json:"batch_window_start,omitempty"`
	BatchWindowEnd          *time.Time     `json:"batch_window_end,omitempty"`
	BatchObservationIDsJSON datatypes.JSON `json:"batch_observation_ids_json,omitempty" gorm:"type:jsonb"`
